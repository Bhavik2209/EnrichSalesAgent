      ...
      <div className="max-w-[1200px] mx-auto flex items-center justify-between px-4 sm:px-6 h-14">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[16px] sm:text-[18px] font-extrabold tracking-tight text-primary-ink">Industrility</span>
          </div>
          <span className="text-secondary-ink/60 hidden md:inline">|</span>
          <span className="text-[14px] font-medium text-secondary-ink hidden md:inline truncate">EnrichSalesAgent</span>
        </div>
